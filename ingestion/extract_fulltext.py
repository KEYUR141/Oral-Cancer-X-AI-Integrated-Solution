...
from ingestion.config import PDF_RAW_DIR, EXTRACTED_TEXT_DIR
...
def main():
    ...
    for i, filename in enumerate(pdf_files, 1):
        ...
        output_path = os.path.join(EXTRACTED_TEXT_DIR, f"{paper_id}.json")
    ...
    logger.info(f"Output in:  {EXTRACTED_TEXT_DIR}")
